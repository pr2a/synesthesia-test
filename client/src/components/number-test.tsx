...
export function NumberTest({ items, colors, onResponse, onComplete, onHelp }: NumberTestProps) {
      ...
      <Card className="shadow-lg">
        <CardContent className="p-8">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold text-slate-900 mb-2">Number-Color Association Test</h3>
            <p className="text-slate-600">Select the color that feels most natural for each number</p>
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-600">What color do you associate with this number?</p>
          </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="space-x-4">
              ...
              >
                {currentIndex < items.length - 1 ? 'Next Number' : 'Complete Test'}
              </Button>
            </div>
          </div>
        </CardContent>
